...
df = load_and_prepare(ticker='META', start_date='2020-01-01', end_date='2024-01-01')
...
threshold = 0.48 # Adjust this threshold based on your needs
...
save_model(model, 'model_META.pickle')
...
save_model(best_model, 'grid_model_META.pickle')
