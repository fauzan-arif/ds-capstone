...
df = load_and_prepare(ticker='msft', start_date='2020-01-01', end_date='2024-01-01')
...
save_model(model, 'model_msft.pickle')
...
save_model(best_model, 'grid_model_msft.pickle')
