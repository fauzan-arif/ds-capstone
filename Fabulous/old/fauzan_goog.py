...
df = load_and_prepare(ticker='GOOG', start_date='2020-01-01', end_date='2024-01-01')
...
# save model
save_model(model, 'grid_model_GOOG.pickle')
...
# save model
save_model(best_model, 'model_GOOG.pickle')